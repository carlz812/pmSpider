var sendPost = require("./sendPost.js");
...
function getServerData(method, object, cookie, callback) {
    var param = getParam(method, object);
    let url = 'https://www.aqistudy.cn/apinew/aqistudyapi.php',
        data = {
            d: param
        };
    sendPost.httpPost(url, data, cookie).then((data) => {
